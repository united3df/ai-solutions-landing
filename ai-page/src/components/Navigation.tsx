...
const Navigation: React.FC = () => {
  ...
  // Get the current path relative to /ai-page
  const currentPath = location.pathname.replace("/ai-page", "").replace(/^\//, "") || "csv";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-4">
            ...
            <Link to="/ai-page" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
