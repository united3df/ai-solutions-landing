...
import { useTranscription, TranscriptionStatus } from "../../lib";
...
const TranscriptionTool: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col text-slate-200">
      {/* Header */}
      <header className="px-6 py-4 flex items-center justify-between border-b border-white/10 glass-card sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-lime-500 rounded-full flex items-center justify-center font-bold text-slate-900 italic shadow-lg shadow-lime-500/20">
            AI
          </div>
          <div>
            <h1 className="font-bold text-xl tracking-tight text-white">AI TRANSCRIPTION</h1>
